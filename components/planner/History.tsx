    ...
    return (
      <div className="w-full max-w-4xl mx-auto">
        <div className="flex items-center justify-between mb-6">
          ...
          <h2 className="text-2xl font-bold text-green-800">{selectedPlan.name}</h2>
          ...
          <CardHeader>
            <div className="flex justify-between items-start">
              ...
              <div className="flex gap-2">
                <Badge variant={getGoalBadgeVariant(selectedPlan.userInput.goal)}>
          ...
          <CardContent>
            <div className="space-y-6">
                  ...
                  {selectedPlan.meals.map((meal, index) => (
                    <div key={index} className="p-4 border rounded-lg">
                      <div className="flex justify-between items-start mb-2">
                        <h5 className="font-semibold capitalize">{meal.name}</h5>
              ...
              <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-4">
                <h4 className="font-semibold text-yellow-800 mb-2">Expert Tip</h4>
                <p className="text-yellow-700 text-sm">{selectedPlan.tip}</p>
              </div>
            </div>
          </CardContent>
        </Card>
    ...
    <div className="w-full max-w-6xl mx-auto">
      ...
      <div className="flex flex-col sm:flex-row gap-4 mb-6">
        ...
        <DropdownMenu>
          ...
          <DropdownMenuContent>
            <DropdownMenuItem onClick={() => setFilterGoal("all")}>
              All Goals
            </DropdownMenuItem>
            <DropdownMenuItem onClick={() => setFilterGoal("weight_loss")}>
              Weight Loss
            </DropdownMenuItem>
            <DropdownMenuItem onClick={() => setFilterGoal("muscle_gain")}>
              Muscle Gain
            </DropdownMenuItem>
            <DropdownMenuItem onClick={() => setFilterGoal("maintain")}>
              Maintain Weight
            </DropdownMenuItem>
          </DropdownMenuContent>
        </DropdownMenu>
                ...
                <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
                  <div className="flex-1">
                    <div className="flex items-start justify-between mb-2">
                      ...
                      <div className="flex gap-2">
                        <Badge variant={getGoalBadgeVariant(plan.userInput.goal)}>
