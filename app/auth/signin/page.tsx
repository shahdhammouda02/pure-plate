...
export default function SignInPage() {
  ...
  {/* Right side form */}
  <div className="w-full lg:w-1/2 h-full flex flex-col items-center justify-center bg-green-50 py-8 sm:py-12 lg:py-32 px-4 sm:px-6 lg:px-10 rounded-3xl lg:rounded-r-3xl lg:rounded-l-none shadow-inner"
       style={{
         minHeight: '500px',
         maxHeight: '800px'
       }}>
    ...
    <div className="flex flex-col items-center space-y-2 mb-4 sm:mb-6">
      <Image 
        ...
        width={80} 
        height={80}
        className="w-16 h-16 sm:w-20 sm:h-20 lg:w-32 lg:h-14"
      />
    ...
    <form
      ...
      className="w-full max-w-xs sm:max-w-sm lg:max-w-md bg-white p-4 sm:p-6 lg:p-8 rounded-2xl shadow-md space-y-4 sm:space-y-5"
    >
      {/* Email */}
      <div>
